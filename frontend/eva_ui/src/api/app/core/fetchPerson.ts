...
const apiBase = apiUrl.core.person;

export async function fetchPersonList(filters: person.IPersonFilter) {
  const {
    email__icontains,
...
export async function personGetId(id: number, forceCache?: boolean) {
