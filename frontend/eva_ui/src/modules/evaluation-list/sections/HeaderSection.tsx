...
import { useDetailDashboardContext } from '../providers'

export const HeaderSection = () => {
  const { dataValues } = useDetailDashboardContext()
  ...
  return (
    <>
      <main className="flex gap-4 justify-between items-center px-6 py-2 container">
        ...
        <div className="flex flex-col items-center">
          {isLoading ? (
            ...
            <h1 className="font-bold">{dataValues?.ultima_evaluacion}</h1>
          )}
