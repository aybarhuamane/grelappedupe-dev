...
const LazyCharData = lazy(() =>
  import("@/modules/director/pages/EvaluacionDetails/CharData").then((mod) => ({
    default: mod.CharData,
  }))
);

interface ITeacherGraphicResumeProps {
  id: string;
}

export const TeacherGraphicResume = (props: ITeacherGraphicResumeProps) => {
  const { id } = props;
  ...
  if (loadingDona) {
    return (
      <div className="p-6 bg-white grid gap-6">
