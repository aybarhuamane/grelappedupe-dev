...
import { Table, TableHeader } from "@/components/ui/table-dos";
...
export function CustomDataTableEvaluation<TData, TValue>({
  columns,
  data,
  hasPagination = true,
  hasToolbar = true,
    ...
    <>
      <div className="bg-white border rounded">
        <Table className="border rounded">
          <TableHeader className="sticky h-12 top-0 bg-gray-100">
      ...
      <div className="flex justify-end items-center gap-4">
        {hasPagination &&
          paginationProps &&
          paginationProps.page !== undefined &&
          paginationProps.pageSize !== undefined &&
          paginationProps.count !== undefined && (
